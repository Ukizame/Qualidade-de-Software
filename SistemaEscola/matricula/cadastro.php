  ...
  <div class="container">
    <form method="post">
      <table class="table">
        ...
        <tr>
          <td class="left">Selecione a materia:
        ...
        <tr>
          <td class="left">Selecione o aluno:
        ...
        <tr>
          <td class="left">Selecione o professor:
        ...
        <tr>
          <td class="left"><input type="submit" name="cadastrar" value='Cadastrar'></td>
        </tr>
        <tr>
          <td class="left"><input type="submit" name="voltar" value='Voltar'></td>
        </tr>
      </table>
    </form>
  </div>
